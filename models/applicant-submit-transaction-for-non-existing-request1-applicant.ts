 ...
 * @export
 * @interface ApplicantSubmitTransactionForNonExistingRequest1Applicant
 */
export interface ApplicantSubmitTransactionForNonExistingRequest1Applicant {
    /**
     ...
     * @type {string}
     * @memberof ApplicantSubmitTransactionForNonExistingRequest1Applicant
     */
