 ...
 * 
 * @export
 * @interface AnalysisStandaloneCryptoInitiationRequest
 */
export interface AnalysisStandaloneCryptoInitiationRequest {
    /**
     * `BTC`, `ETH`, `BCH`, `LTC`, `USDT`, `ERC-20`, `BSV`, `XLM`, ...
     * @type {string}
     * @memberof AnalysisStandaloneCryptoInitiationRequest
     */
    'currency': string;
    /**
