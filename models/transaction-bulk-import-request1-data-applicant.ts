 ...
 * @export
 * @interface TransactionBulkImportRequest1DataApplicant
 */
export interface TransactionBulkImportRequest1DataApplicant {
    /**
     ...
     * @type {string}
     * @memberof TransactionBulkImportRequest1DataApplicant
     */
