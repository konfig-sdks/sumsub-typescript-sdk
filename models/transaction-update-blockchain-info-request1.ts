 ...
 * 
 * @export
 * @interface TransactionUpdateBlockchainInfoRequest1
 */
export interface TransactionUpdateBlockchainInfoRequest1 {
    /**
     * A crypto transaction ID received from the blockchain.
     * @type {string}
     * @memberof TransactionUpdateBlockchainInfoRequest1
     */
    'fingerprint'?: string;
}
