 ...
 * 
 * @export
 * @interface ApplicantAddConsentToProfileRequestRecordsInner
 */
export interface ApplicantAddConsentToProfileRequestRecordsInner {
    /**
     * A consent text.
     * @type {string}
     * @memberof ApplicantAddConsentToProfileRequestRecordsInner
     */
    'content'?: string;
}
