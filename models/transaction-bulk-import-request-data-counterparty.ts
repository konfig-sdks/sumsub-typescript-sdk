 ...
 * @export
 * @interface TransactionBulkImportRequestDataCounterparty
 */
export interface TransactionBulkImportRequestDataCounterparty {
    /**
     ...
     * @type {string}
     * @memberof TransactionBulkImportRequestDataCounterparty
     */
