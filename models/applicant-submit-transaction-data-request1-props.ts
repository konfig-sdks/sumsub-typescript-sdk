 ...
 * @export
 * @interface ApplicantSubmitTransactionDataRequest1Props
 */
export interface ApplicantSubmitTransactionDataRequest1Props {
    /**
     * 
     * @type {string}
     * @memberof ApplicantSubmitTransactionDataRequest1Props
     */
    'customTxnLimit'?: string;
}
