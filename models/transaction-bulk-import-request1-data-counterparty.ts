 ...
 * @export
 * @interface TransactionBulkImportRequest1DataCounterparty
 */
export interface TransactionBulkImportRequest1DataCounterparty {
    /**
     ...
     * @type {string}
     * @memberof TransactionBulkImportRequest1DataCounterparty
     */
