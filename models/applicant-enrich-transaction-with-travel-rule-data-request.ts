 ...
 * 
 * @export
 * @interface ApplicantEnrichTransactionWithTravelRuleDataRequest
 */
export interface ApplicantEnrichTransactionWithTravelRuleDataRequest {
    /**
     * Participant full name.
     * @type {string}
     * @memberof ApplicantEnrichTransactionWithTravelRuleDataRequest
     */
    'fullName': string;
}
