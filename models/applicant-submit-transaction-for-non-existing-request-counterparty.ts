 ...
 * @export
 * @interface ApplicantSubmitTransactionForNonExistingRequestCounterparty
 */
export interface ApplicantSubmitTransactionForNonExistingRequestCounterparty {
    /**
     ...
     * @type {string}
     * @memberof ApplicantSubmitTransactionForNonExistingRequestCounterparty
     */
