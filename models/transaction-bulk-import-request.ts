...
import { TransactionBulkImportRequestData } from './transaction-bulk-import-request-data';

/**
 * 
 * @export
 * @interface TransactionBulkImportRequest
 */
export interface TransactionBulkImportRequest {
     ...
     * @type {string}
     * @memberof TransactionBulkImportRequest
     */
    'applicantId': string;
    /**
     * 
     * @type {TransactionBulkImportRequestData}
     * @memberof TransactionBulkImportRequest
     */
