 ...
 * @export
 * @interface ApplicantSubmitTransactionDataRequest1Counterparty
 */
export interface ApplicantSubmitTransactionDataRequest1Counterparty {
    /**
     ...
     * @type {string}
     * @memberof ApplicantSubmitTransactionDataRequest1Counterparty
     */
