 ...
 * 
 * @export
 * @interface TransactionUpdateBlockchainInfoRequest
 */
export interface TransactionUpdateBlockchainInfoRequest {
    /**
     * A crypto transaction ID received from the blockchain.
     * @type {string}
     * @memberof TransactionUpdateBlockchainInfoRequest
     */
    'fingerprint'?: string;
}
