 ...
 * @export
 * @interface ApplicantSubmitTransactionForNonExistingRequestApplicant
 */
export interface ApplicantSubmitTransactionForNonExistingRequestApplicant {
    /**
     ...
     * @type {string}
     * @memberof ApplicantSubmitTransactionForNonExistingRequestApplicant
     */
