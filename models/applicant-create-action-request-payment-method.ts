 ...
 * @export
 * @interface ApplicantCreateActionRequestPaymentMethod
 */
export interface ApplicantCreateActionRequestPaymentMethod {
    /**
     * A payment type. Can be: `bankCard`, `eWallet`, `wireTransfer`.
     * @type {string}
     * @memberof ApplicantCreateActionRequestPaymentMethod
     */
    'type': string;
    /**
