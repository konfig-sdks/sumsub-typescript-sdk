 ...
 * @export
 * @interface ApplicantSubmitTransactionDataRequestProps
 */
export interface ApplicantSubmitTransactionDataRequestProps {
    /**
     * 
     * @type {string}
     * @memberof ApplicantSubmitTransactionDataRequestProps
     */
