 ...
 * 
 * @export
 * @interface CheckPerformNameCrossValidationRequestIdDocsInner
 */
export interface CheckPerformNameCrossValidationRequestIdDocsInner {
    /**
     * First name.
     * @type {string}
     * @memberof CheckPerformNameCrossValidationRequestIdDocsInner
     */
    'firstName': string;
    /**
     * Middle name.
