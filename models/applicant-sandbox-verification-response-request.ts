 ...
 * 
 * @export
 * @interface ApplicantSandboxVerificationResponseRequest
 */
export interface ApplicantSandboxVerificationResponseRequest {
    /**
     ...
     * @type {string}
     * @memberof ApplicantSandboxVerificationResponseRequest
     */
    'reviewAnswer': string;
    /**
