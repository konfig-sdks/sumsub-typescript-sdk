 ...
 * @export
 * @interface TransactionBulkImportRequestDataApplicant
 */
export interface TransactionBulkImportRequestDataApplicant {
    /**
     ...
     * @type {string}
     * @memberof TransactionBulkImportRequestDataApplicant
     */
