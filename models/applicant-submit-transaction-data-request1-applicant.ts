 ...
 * @export
 * @interface ApplicantSubmitTransactionDataRequest1Applicant
 */
export interface ApplicantSubmitTransactionDataRequest1Applicant {
    /**
     ...
     * @type {string}
     * @memberof ApplicantSubmitTransactionDataRequest1Applicant
     */
