 ...
 * @export
 * @interface ApplicantSubmitTransactionForNonExistingRequest1Counterparty
 */
export interface ApplicantSubmitTransactionForNonExistingRequest1Counterparty {
    /**
     ...
     * @type {string}
     * @memberof ApplicantSubmitTransactionForNonExistingRequest1Counterparty
     */
