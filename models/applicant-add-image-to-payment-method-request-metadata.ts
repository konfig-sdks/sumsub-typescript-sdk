 ...
 * @export
 * @interface ApplicantAddImageToPaymentMethodRequestMetadata
 */
export interface ApplicantAddImageToPaymentMethodRequestMetadata {
    /**
     * 
     * @type {string}
     * @memberof ApplicantAddImageToPaymentMethodRequestMetadata
     */
    'idDocType': string;
    /**
     * 
