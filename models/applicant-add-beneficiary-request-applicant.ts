 ...
 * @export
 * @interface ApplicantAddBeneficiaryRequestApplicant
 */
export interface ApplicantAddBeneficiaryRequestApplicant {
    /**
     * applicantId of beneficiary
     * @type {string}
     * @memberof ApplicantAddBeneficiaryRequestApplicant
     */
    'id'?: string;
}
