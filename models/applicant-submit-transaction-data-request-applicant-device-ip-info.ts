 ...
 * @export
 * @interface ApplicantSubmitTransactionDataRequestApplicantDeviceIpInfo
 */
export interface ApplicantSubmitTransactionDataRequestApplicantDeviceIpInfo {
    /**
     * Position latitude in decimal degrees.
     * @type {number}
     * @memberof ApplicantSubmitTransactionDataRequestApplicantDeviceIpInfo
     */
    'lat'?: number;
    /**
