 ...
 * 
 * @export
 * @interface ApplicantImportCompletedRequestReviewReview
 */
export interface ApplicantImportCompletedRequestReviewReview {
    /**
     * Reason of rejection for end-user
     * @type {string}
     * @memberof ApplicantImportCompletedRequestReviewReview
     */
